...
const ScaleH = () => {
    ...
    useGSAP(() => {
        ...
        if (profileRef.current) {
            gsap.fromTo(
                profileRef.current,
                { scale:1 }, // Start with 80% width
                {
                    scale:1.3, // Expand to full width
                    duration: 1.5,
                    scrollTrigger: {
    ...
    return (
        <>
            ...
            <div className="w-full bg-black -mt-80 relative z-10 pb-52">
                    ...
                    <div className="flex flex-col items-start gap-2">
                        <div className="w-full flex flex-col items-start -space-y-5 lg:flex-row lg:-space-y-0 lg:items-center lg:justify-center">
                            <div className="overflow-hidden">
                                <h1 ref={headRef01} className="font-sohne text-[72px] text-[#e6e6e6] font-medium uppercase tracking-tight px-2 sm:text-[104px] md:font-bold lg:px-6 lg:tracking-normal xl:text-[144px] 2xl:text-[172px]">Myself</h1>
                            </div>
                            <div className="flex items-start">
                                <div className="overflow-hidden">
                                    <h1 ref={headRef02} className="font-sohne text-[72px] text-[#e6e6e6] font-medium uppercase tracking-tight px-2 sm:text-[104px] md:font-bold lg:px-6 lg:tracking-normal xl:text-[144px] 2xl:text-[172px]">ayan</h1>
                                </div>
